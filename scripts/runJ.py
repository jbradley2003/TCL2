...
# Paths
# root = os.getcwd()
methyl_csv_root = f'./../data'
methyl_xyz_path = f'./../structs/TEMPO/tempo.xyz'
hfc_path = f'./../orca/hyperfine/TEMPO/tempo.log'
...
for i in range(numBathInstances):
    ...
    coherence,modDepthFreqMap = getCohBath(hfc_path,['H','F'],times,boxLength,bathType,concentration,True,methyl_csv_root,methyl_xyz_path)
...
with open(f'tempo_bL{boxLength}_nB{numBathInstances}_c10_TCL2_filtered_geminal.pkl','wb') as f:
