...
for i in range(numBathInstances):
    ...
    coherence,modDepthFreqMap = getCoh(hfc_path,['H','F'],times,True,methyl_csv_root,methyl_xyz_path)
...
with open(f'tempo_bL{boxLength}_nB{numBathInstances}_c10_TCL2_filtered_geminal_no_bath.pkl','wb') as f:
