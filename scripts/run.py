...
for i in range(numBathInstances):
    ...
    coherence,modDepthFreqMap = getCohBath(hfc_path,['H','F'],times,boxLength,bathType,concentration)
...
with open(f'tempo_bL{boxLength}_nB{numBathInstances}_c10_TCL2_filtered_geminal_no_methyl.pkl','wb') as f:
